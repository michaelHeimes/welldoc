...
/*
	wp_register_script( 
		'theme-app', 
		get_template_directory_uri() . '/includes/js/general.js', 
		array( 
			'jquery', 
			), 
		'1.0.0'); 
...
function am_add_css( ) {
    ...
    // external CSS
    $am_links = array(
        'https://use.typekit.net/jxa1fge.css'
    ); // example: array('https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i');
...
function am_the_widgets_init() {
    ...
    register_sidebar(array('name' => __( 'News and Events Sidebar', 'am' ), 'id' => 'sidebar-news-events', 'before_widget' => $before_widget, 'after_widget' => $after_widget, 'before_title' => $before_title, 'after_title' => $after_title ) );
    register_sidebar(array('name' => __( 'Insights Sidebar', 'am' ), 'id' => 'sidebar-insights', 'before_widget' => $before_widget, 'after_widget' => $after_widget, 'before_title' => $before_title, 'after_title' => $after_title ) );
}
