...
<div class="body">
	...
	<div class="image-text-section">
		<div class="image-half" style="background-color: #f7f7f7;">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/image-1.png" alt="" />
		</div>
		<div class="text-half">
			<div>
	...
	<div class="image-text-section image-on-right">
		<div class="image-half" style="background-color: #016ecd;">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/image-2.png" alt="" />
		</div>
		<div class="text-half">
			<div>
	...
	<div class="image-text-section no-bg-img have-icons-list">
		<div class="image-half">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/image-3.png" alt="" />
		</div>
		<div class="text-half">
			<div>
	...
	<div class="image-text-section image-on-right">
		<div class="image-half" style="background-color: #000;">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/image-4.png" alt="" />
		</div>
		<div class="text-half">
			<div>
	...
	<div class="watch-video" style="background-image:url('<?php echo get_stylesheet_directory_uri(); ?>/images/watch-video-thumb.png')">
		<div class="container">
			<h3>Scales  personalized  health  solutions  to  the  population  level</h3>
	...
	<div class="our-team">
		<div class="our-team-img">
			<div>
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/team-left-img.png" alt="" />
			</div>
		</div>
	...
	<div class="request-a-demo">
		<div class="container">
			...
			<div class="demo-right">
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/bluestar-center_iphone.png" alt="" />
			</div>
		</div>
	</div>
