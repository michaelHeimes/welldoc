<?php
/*
Template Name: Health Plans And Systems
...
-->
	...
	<div class="healt-cost">
		<div class="container">
			<div class="text">
				<h2>Healthier Members. Lower Costs. <strong>Simple.</strong></h2>
				<section>
					<article>
	...
	<div class="demo-request right custom">
		...
		<div class="video">
			<a class="play" data-fancybox="" href="https://vimeo.com/261328145"><img alt="" src="<?php bloginfo('template_directory'); ?>/images/bg_v_2.jpg"></a>
		</div>
	</div>
</div>
