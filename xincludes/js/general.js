...
// Back Page Line Animation
	if ($(".back-page-animated-lines").length) {
		...
		TweenMax.set(".text.white_content_background", {scaleX: 0.95, scaleY: 0.95, boxShadow: '0px 0px 0px 0 rgba(0,0,0,0.60)'})
		
		window.onload = function(){
			
			TweenMax.to(".text.white_content_background", 1, {scaleX: 1, scaleY: 1, boxShadow: '-25px 50px 50px 0 rgba(0,0,0,0.60)', ease: Power2.easeOut})
...
/*
	if ($(".text.white_content_background").length) {
		var tween = TweenMax.fromTo(".text.white_content_background", 0.3,
		...
		new ScrollMagic.Scene({
			triggerElement: ".text.white_content_background",
...
/*
	if ($(".text-section").length) {
		$(".text-section").each(function() {		
			...
			// 	Heading
			if ($(".text-section h2").length) {
				var tween = TweenMax.fromTo(".text-section h2", 0.3,
					{x: -30, autoAlpha: 0},
			...
			// 	blue pipe
			if ($(".text-section-h2-pipe").length) {
				var tween = TweenMax.fromTo(".text-section-h2-pipe", 0.3,
					{height: 0},
			...
			if ($(".text-section p").length) {
				var tween = TweenMax.fromTo(".text-section p", 0.3,
					{autoAlpha: 0},
...
// image-text-section Modules
	if ($(".image-text-section").length) {
		$(".image-text-section").each(function() {	
			...
			// 	h2 Heading
/*
			if ($(".image-text-section h2").length) {
				var tween = TweenMax.fromTo(".image-text-section h2", 0.3,
					{x: -30, autoAlpha: 0},
					{x: 0, autoAlpha: 1, ease: Power2.easeOut}
				);
...
*/
			...
			// 	blue pipe
/*
			if ($(".image-text-section-h2-pipe").length) {
				var tween = TweenMax.fromTo(".image-text-section-h2-pipe", 0.3,
					{height: 0},
					{height: 14, ease: Power2.easeOut}
				);
			...
			if ($(".image-text-section section").length) {
				var tween = TweenMax.fromTo(".image-text-section section p", 0.3,
					{autoAlpha: 0},
					{autoAlpha: 1, ease: Power2.easeOut}
				);
...
// 		Pinned Phone Scroll
	if($('#pinned_phone_element').length ) {
		...
		var pinDuration = (544 * 2.2);
		var scrollDuration = (544 * 2);
		var tweenOffset = 544;
		var scrollOffset = -(544 * 2);
